...
-   <a
    href="#figure-1-hierarchical-clustering-with-wards-linkage-and-euclidean-distance-of-6964-single-cell-profiles-and-2141-features-selected-with-awst."
    id="toc-figure-1-hierarchical-clustering-with-wards-linkage-and-euclidean-distance-of-6964-single-cell-profiles-and-2141-features-selected-with-awst.">Figure
    1: Hierarchical clustering with Ward’s linkage and Euclidean distance of
    6,964 single-cell profiles and 2,141 features selected with AWST.</a>
...
-   <a
    href="#figure-2a-heat-map-of-each-clusters-top-200-standardized-log-fold-changes-in-clust3-to-a-synthetic-background."
    id="toc-figure-2a-heat-map-of-each-clusters-top-200-standardized-log-fold-changes-in-clust3-to-a-synthetic-background.">Figure
    2a: Heat-map of each cluster’s top 200 standardized log fold-changes in
    clust3 to a synthetic background.</a>
-   <a
    href="#figure-2b-heat-map-of-the-top-200-gene-expression-levels-associated-with-each-cluster-in-clust3."
    id="toc-figure-2b-heat-map-of-the-top-200-gene-expression-levels-associated-with-each-cluster-in-clust3.">Figure
...
-   <a
    href="#figure-3a-heat-map-of-each-clusters-top-50-standardized-log-fold-changes-in-clust5-to-a-synthetic-background."
    id="toc-figure-3a-heat-map-of-each-clusters-top-50-standardized-log-fold-changes-in-clust5-to-a-synthetic-background.">Figure
    3a: Heat-map of each cluster’s top 50 standardized log fold-changes in
    clust5 to a synthetic background.</a>
-   <a
    href="#figure-3b-heat-map-of-the-top-50-gene-expression-levels-associated-with-each-cluster-in-clust5."
    id="toc-figure-3b-heat-map-of-the-top-50-gene-expression-levels-associated-with-each-cluster-in-clust5.">Figure
...
# Figure 2a: Heat-map of each cluster’s top 200 standardized log fold-changes in clust3 to a synthetic background.
...
# Figure 2b: Heat-map of the top 200 gene expression levels associated with each cluster in clust3.
...
# Figure 3a: Heat-map of each cluster’s top 50 standardized log fold-changes in clust5 to a synthetic background.
...
# Figure 3b: Heat-map of the top 50 gene expression levels associated with each cluster in clust5.
